...
form.addEventListener("submit", (event) => {
  ...
  if (valueSearch.value !== "") {
    ...
    alert("Please enter a city name"); // Display an alert if the user hasn't entered a city name
  }
});
...
// This controls the accessibility. you can change from light to dark theme
